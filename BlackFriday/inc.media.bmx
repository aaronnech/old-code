...
Global POINTS:Int
Global Clock:TClock = New TClock
Global G:TGift = New TGift

'font
Global myfont:TImageFont = LoadImageFont("media/Font.ttf", 18)
Global analog:TImageFont = LoadImageFont("media/Font2.ttf", 72)
Global pointfont:TImageFont = LoadImageFont("media/Font.ttf", 30)


Const path:String = "WASHINGTON_LAKEWOOD/"
'Sound
...
Global stopwatch:TImage = LoadImage("media/stopwatch.png")
Global BGSS:TImage